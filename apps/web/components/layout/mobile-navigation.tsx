...
function MobileNavigation({ items }: MobileNavigationProps) {
  ...
  const menu = open ? (
    <div
      ...
      className={cn(
        "fixed inset-0 z-[80] h-[100svh] overflow-hidden bg-foreground/18 transition-opacity duration-300 ease-out motion-reduce:transition-none",
    ...
    >
      <div
        className={cn(
          "absolute rounded-full bg-background shadow-[0_0_0_1px_color-mix(in_oklab,var(--color-border)_80%,transparent)] transition-transform duration-[520ms] ease-[cubic-bezier(0.2,0.9,0.22,1)] will-change-transform motion-reduce:transition-none",
      ...
      <div className="relative flex h-[100svh] min-h-0 flex-col overflow-hidden">
        <div className="sticky top-0 z-10 shrink-0 bg-background/94 px-4 pt-4 backdrop-blur-xl sm:px-6">
          <div className="mx-auto flex w-full max-w-2xl items-center justify-between gap-4 py-1">
            ...
            <Button
              ...
              onClick={closeMenu}
              className="rounded-full border border-border bg-background/90 text-foreground shadow-sm hover:bg-secondary hover:text-foreground"
            >
  ...
  return (
    <>
      <Button
        ...
        onClick={openMenu}
        className="rounded-full border border-border/80 bg-background/86 text-foreground shadow-sm backdrop-blur-md hover:bg-secondary hover:text-foreground"
      >
